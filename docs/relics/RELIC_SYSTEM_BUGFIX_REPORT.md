...
Ending SHA: `9fe8b8e13f764e6bbf7ed4dca51b02fd17785479` (working tree is intentionally uncommitted)  
Intended implementation branch: `relic-addition`  
Observed final checkout: `codex/relic-icons` (an external checkout moved the shared workspace at 2026-08-07 21:19:54 +0900; both branches currently point to the same base SHA)
...
- fix the environment asset preload error and update lifecycle/icon browser assertions to current behavior;
- repeat manual Single Player and two-client Multiplayer qualification after the concurrent TPS-camera and relic-icon work is integrated.
