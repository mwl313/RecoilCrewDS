...
function state(time: number, z: number, yaw = 0): MatchState {
  return {
    ...
    turret: { yaw: 0, pitch: 0, cannonHeld: false, cannonHoldT: 0, cannonChargeRatio: 0, cannonChargeFull: false, chargeT: 0, cannonCooldown: 0, cannonFlash: 0, mgCooldown: 0, mgFiring: false, jackpotReady: false, jackpotCooldown: 0 },
