...
export function legacyGameConfigFromContent(pack: ContentPack, modeId = pack.modeId): GameConfig {
  ...
  return {
    tank: {
      ...
      dashPeakSpeedMultiplier: tank.dashPeakSpeedMultiplier,
      dashBurstSeconds: tank.dashBurstSeconds,
      dashAccelerationSeconds: tank.dashAccelerationSeconds,
      dashDirectionLockSeconds: tank.dashDirectionLockSeconds,
      dashLateSteeringInfluence: tank.dashLateSteeringInfluence,
      dashRecoverySeconds: tank.dashRecoverySeconds,
      dashRecoveryStartRatio: tank.dashRecoveryStartRatio,
