...
export const tankSchema = z.object({
  ...
  dashPeakSpeedMultiplier: positiveNumber.default(2.05),
  dashBurstSeconds: positiveNumber.default(0.38),
  dashAccelerationSeconds: positiveNumber.default(0.08),
  dashDirectionLockSeconds: nonNegativeNumber.default(0.12),
  dashLateSteeringInfluence: z.number().finite().min(0).max(1).default(0.2),
  dashRecoverySeconds: positiveNumber.default(0.2),
  dashRecoveryStartRatio: z.number().finite().min(0).max(1).default(0.28),
